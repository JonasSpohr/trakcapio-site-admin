...
export class HomeComponent implements OnInit {
    ...
    refresh(): void {
        ...
        this.todayStatusCanceledItems = [];
        this.todayStatusConfirmedItems = [];
        this.loadTodayRoutesData();
    }
                    ...
                    if (response.success) {
                        ...
                        for (let i = 0; i < this.todayItems.length; i++) {
                            ...
                            for (let p = 0; p < item.packages.length; p++) {
                                ...
                                itemReturn.clientAddress = `${address.street} Nº ${number} ${complement}, ${address.city} (${address.state}) - CEP: ${address.zipCode}`
